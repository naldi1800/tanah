<div class="min-h-screen bg-zinc-50/80 dark:bg-zinc-900/80 backdrop-blur-sm p-6 rounded-3xl">
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="flex items-start justify-between gap-4 mb-8">
            <div class="space-y-2">
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Data Alternatif</h1>
                <p class="text-gray-600 dark:text-gray-400">Daftar alternatif (nama jalan) yang akan dievaluasi</p>
            </div>
        </div>
        ...
        <section class="bg-white dark:bg-gray-800 rounded-3xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
            <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">Daftar Alternatif</h2>
                            ...
                            <tr>
                                <td colspan="2" class="px-4 py-8 text-center text-gray-500 dark:text-gray-400">
                                    <div class="flex justify-center items-center gap-2">
                                        ...
                                        <span>Tidak ada alternatif yang sesuai</span>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
            ...
            <div class="mt-4 text-sm text-gray-600 dark:text-gray-400">
                <p>Total alternatif: <span class="font-semibold">{{ count($alternatives) }}</span></p>
            </div>
        </section>
        ...
        <section class="bg-blue-50 dark:bg-blue-900/20 rounded-3xl border border-blue-200 dark:border-blue-800 p-6">
            <div class="flex gap-4">
                ...
                <div>
                    <h3 class="font-semibold text-blue-900 dark:text-blue-300 mb-2">Tentang Alternatif</h3>
                    <p class="text-sm text-blue-800 dark:text-blue-400">
                        Alternatif merupakan nama jalan-jalan yang menjadi pilihan lokasi budidaya tanaman porang. 
                        Setiap alternatif akan dievaluasi terhadap setiap kriteria untuk mendapatkan rekomendasi terbaik.
                    </p>
                </div>
            </div>
        </section>
