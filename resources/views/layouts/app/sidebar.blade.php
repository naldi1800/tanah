    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:sidebar.nav>
                ...
                <flux:sidebar.group :heading="__('Tanah')" class="grid">
                    <flux:sidebar.item icon="circle-stack" :href="route('jenistanah.index')" :current="request()->routeIs('jenistanah.index')" wire:navigate>
                        {{ __('Jenis Tanah') }}
                    </flux:sidebar.item>
